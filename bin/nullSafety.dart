...
void main(){
 ...
 // double ageDouble = age.toDouble(); //akan error


  int? age2 = null;

  if(age2 != null){
    double age2Double = age2.toDouble();
    print(age2Double);
  }
...
- Kada kita butuh melakukan konversi dari tipe data nullable ke non nullable, namun jika datanya ternyata null, kita ganti dengan default value
- Untuk melakukan hal tersebut, kita tidak perlu menggunakan if else, kita cukup menggunakan operator ?? (tanda tanya dua kali)
   */

  String? guest;
 // guest = 'jayady';
  String guestNama = guest ?? 'guest';
  print(guestNama);
